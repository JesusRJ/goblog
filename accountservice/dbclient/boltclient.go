...
import (
	...
	"github.com/jesusrj/goblog/accountservice/model"
)

// IBoltClient Bolt Client Interface
...
// BoltClient Bolt client encapsulated
type BoltClient struct {
	boltDB *bolt.DB
}

// OpenBoltDB Open BoltDB database and create a file named "accounts.db"
